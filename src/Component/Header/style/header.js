...
export const Background = style.div`
    ...
    background:  url(${({ src }) =>
      src
        ? `../images/misc/${src}.jpg`
        : `../images/misc/home-bg.jpg`})  left top / cover no-repeat ;
...
export const Feature = style(Frame)`  
...
export const FeatureCallOut = style.h1`
    color: white;
    font-size: 50px;
    font-weight: bold;
    line-height: normal;
...
export const Picture = style.button`
...
`;
//thats the benfit of sending active as props so we can edit and make a nice transation
...
`;
export const PlayButton = style.button`
